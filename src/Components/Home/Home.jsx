    ...
    return (
        <div>
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="flex flex-col justify-center items-center h-[calc(100vh-80px)] font-semibold">
                ...
                <div className="flex flex-col justify-center items-center mb-4">
                    <motion.button
                        ...
                        className="bg-[#2e2e2e] px-8 py-4 text-[#f1f2f4] rounded-lg font-semibold text-lg mb-2"
            ...
            <motion.div
                initial={{ opacity: 0, y: 100 }}
                whileInView={{ opacity: 1, y: 0 }}
                className="object-contain w-[80%] m-auto mt-20">
            ...
            <div
                ...
                <div className="flex flex-col items-center">
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="flex justify-center items-center w-[80%] h-[80vh] gap-4">
                    ...
                    {/* 2nd  */}
                    <div className="flex justify-center items-center flex-row-reverse w-[80%] h-[80vh] gap-4">
                        <motion.div
                            initial={{ opacity: 0, y: 100 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="flex flex-col items-start justify-center w-[50%] h-full relative">
                            ...
                            {/* person Commenting  */}
                            <div>
                                <div className="bg-[#2e2e2e] text-white text-start p-4 rounded-xl rounded-br-none font-semibold w-[300px] absolute -bottom-10 right-20">
                                    <p>I've recommended this app to all my friends and colleagues!</p>
                                    <p className="opacity-60 mt-2">Karl, CTO of a cool startup</p>
                                </div>
                                <img className="absolute h-[80px] -bottom-16 right-0" src="https://framerusercontent.com/images/lKaaStgbmdIe8TfrIkFlKzHazV0.png" alt="person" />
                            </div>
                    ...
                    <div className="flex justify-center items-center w-[80%] h-[100vh] gap-4">
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="flex flex-col items-start justify-center h-full w-[50%] relative">
                            <span className="bg-[#fee9cb] text-[#2e2e2e] px-6 py-2 rounded-full w-fit font-semibold text-lg mb-2">Seamless scheduling</span>
                            <span className="text-5xl font-semibold">Focus on what matters most for you</span>
                            <p className="text-gray-500 text-xl mt-20">Effortlessly plan your day with our intuitive drag-and-drop interface. Sync with multiple calendar platforms, import events from emails, and add participants with just a few clicks</p>
                            <div>
